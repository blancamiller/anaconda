...
% These are trivial dynamics that are useful for debugging
% Hessians.
% bxsfun is the binary singleton expansion fxn for gpuArray
%{
...
if nargout > 1,
    ...
    dpdt = zeros(2*T,2*T);
    for i=1:2,
        % triu: returns upper triangular part of a matrix (matlab fxn)
